...
wire [31: 0] pc_ex, inst_ex, npc_ex, pcadd4_ex, rfrd0_ex, rfrd1_ex, imm_ex, alusrc0_ex, alusrc1_ex, alures_ex;
wire [ 4: 0] rfwa_ex, aluop_ex;
...
INTERSEGMENTREGFILE intersegmentregfile(
    ...
    .pc_ex_in(pc_ex),
    .rfrd0_ex_in(rfrd0_ex),
    .rfrd1_ex_in(rfrd1_ex),
    .imm_ex_in(imm_ex),
    .rfwa_ex_in(rfwa_ex),
    .rfwe_ex_in(rfwe_ex),
