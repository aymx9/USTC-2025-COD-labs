...
HD_PWD='/home/ubuntu/cod lab7/lab7/lab7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cache_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cache_tb.tcl -notrace
